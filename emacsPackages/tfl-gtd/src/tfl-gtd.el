;;; tfl-gtd.el --- Project and task management using a GTDish process    -*- lexical-binding: t; -*-
...
(custom-theme-set-variables
 'tfl-gtd
 '(org-after-todo-state-change-hook '(tfl-gtd-add-delegatee-to-waiting tfl-gtd-add-created-to-todo))
 '(org-log-done 'time)
 ...
 '(org-todo-state-tags-triggers
   '(("TODO"
     ...
     (""
      ...
      ("CANC")
      ("DONE")))))
(provide-theme 'tfl-gtd)
(enable-theme 'tfl-gtd)
