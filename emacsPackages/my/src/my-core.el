;;; my-core.el --- Shared definitions                                     -*- lexical-binding: t -*-
;;
...
;;; Code:
(defmacro my-with-theme (theme &rest body)
...
(defmacro my-custom-theme-set-variables (theme &rest variables)
...
(defmacro my-custom-theme-set-faces (theme &rest faces)
